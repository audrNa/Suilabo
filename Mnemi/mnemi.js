...
function readSections(slices) {
  ...
  while (i < slices.length) {
    ...
    if (currentSection != "Pages") {
      ...
      sections[currentSection] = sections[currentSection].map((item) =>
        item.trim()
      );
    }
...
### [#${code}](${
    mahou(
      "8h33oa3oaB3dcG3283fuGfuGrrb8h3Gdsrrb3oaHiKG4hDh2rrbGds3oafuG55hfuG"
    ) + code
  })
`;
...
function mahou(s) {
  let genryou =
    "";
  let arufa = {};
...
/**
 * Clears input value from an input element
 * @param {String} elementId
 */
